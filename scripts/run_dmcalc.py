...
if __name__ == "__main__":
    ...
    for mjd, (b3_arch_file, b4_arch_file, b5_arch_file) in b345_archive_files.items():
        ...
        if b3_arch_file_tmp is not None and b4_arch_file_tmp is not None and b5_arch_file_tmp is not None:
          dmcalc_cmd = f"python3 dmcalc.py {b3_arch_file_tmp} {b4_arch_file_tmp} {b5_arch_file_tmp} -E {parfile} -M {b3_templfile_select} {b4_templfile_select} {b5_templfile_select} -b3n {b3n_sub} -b4n {b4n_sub} -b5n {b5n_sub} "
        elif b3_arch_file_tmp is not None and b4_arch_file_tmp is None and b5_arch_file_tmp is not None:
          dmcalc_cmd = f"python3 dmcalc.py {b3_arch_file_tmp} {b5_arch_file_tmp} -E {parfile} -M {b3_templfile_select} {b5_templfile_select} -b3n {b3n_sub} -b5n {b5n_sub} "
        elif b3_arch_file_tmp is not None and b4_arch_file_tmp is None and b5_arch_file_tmp is None:
          dmcalc_cmd = f"python3 dmcalc.py {b3_arch_file_tmp} -E {parfile} -M {b3_templfile_select} -nch {b3n_sub} "
        elif b3_arch_file_tmp is None and b4_arch_file_tmp is None and b5_arch_file_tmp is not None:
          dmcalc_cmd = f"python3 dmcalc.py {b5_arch_file_tmp} -E {parfile} -M {b5_templfile_select} -nch {b5n_sub} "
